    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="homePost d-flex flex-column">
                <div class="postOwner">
                    <a href="{{ url('/profile'.'/'.$item->user->id) }}"><img src="{{ asset( $item->user->avatar ) }}"><span> {{ $item->user->name }}</span></a>
                </div>
                <div class="postImg">
                ...
                <div class="postFeatures">
                    <ul>
                        ...
                        <li><button class="postLike" onclick="window.location.href='/post/{{  $item->id }}';"><i class="far fa-comment"></i></button></li>
                    </ul>
                    <ul class="ml-auto">
                        <li>
                ...
                <div class="postComments">
                    <a class="pl-3 pr-1 font-weight-bold" href="{{ url('/profile'.'/'.$item1->user->id) }}"> {{ $item1->user->name }} </a>
                ...
                <form class="postAddComment" action="{{ url('add-comments') }}" method="POST" enctype="multipart/form-data">
                    @csrf
