                ...
                <div class="postPage">
                    ...
                    <div class="details">
                        <div class="comments-container">
                            <div class="caption">
                                <a href="{{  url('/profile'.'/'.$item->user->id) }}"><img class="img-fluid"
                            ...
                            @foreach ($comments as $item1)
                                @if ($ids == $item1->post_id)
                                    <div class="comment">
                                        <a href="{{  url('/profile'.'/'.$item1->user->id)}}"><img class="img-fluid"
                                                                                                  src="{{asset($item->user->avatar)}}"><span> {{ $item1->user->name }} </span></a>
                                        <p class="m-0">
                        ...
                        <div class="features">
                            ...
                            <form class="w-100 add-comment" action="{{ url('add-comments2') }}" method="POST"
